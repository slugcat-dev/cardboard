export default defineEventHandler(async (event) => {
	...
	const templateCards = [
		...
		{ position: { x: 100, y: 200 }, content: '<h1>Bugs &amp; Feature Requests</h1>', type: 'text', created: now },
		{ position: { x: 100, y: 40 }, content: '<h1>Welcome</h1>', type: 'text', created: now },
		{ position: { x: 360, y: 320 }, content: '<h1>Add Images And Links</h1>', type: 'text', created: now },
